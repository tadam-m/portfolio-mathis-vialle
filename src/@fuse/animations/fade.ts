...
const fadeInHalf = trigger('fadeInHalf',
  [
    state('void',
      style({
        opacity  : 0,
...
export { fadeIn, fadeInTop, fadeInBottom, fadeInLeft, fadeInHalf, fadeInRight, fadeOut, fadeOutTop, fadeOutBottom, fadeOutLeft, fadeOutRight };
